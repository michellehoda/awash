...
You know how you can use *hide* or *set aside* to hide rows in a table?
This lets you hide *columns*,
which is a lifesaves if your dataset has lots of attributes.
