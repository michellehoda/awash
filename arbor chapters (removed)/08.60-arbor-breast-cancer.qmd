...
::: {.column-margin}
![[Learn more about the configuration box](08.90-arbor-configuration.qmd).](art/breastCancer-configuration.png){ width=60%}
:::
...
<script>
    ...
    awash.codapInNewTab(theURL, "Click to open in a new tab instead for more space" );
</script>
<br>
...
[just like we did in the previous section](08.50-arbor-measures.qmd).
