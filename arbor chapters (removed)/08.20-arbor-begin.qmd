...
### Branching on a numeric attribute {-}
...
::: {.column-margin}
![Configuring `age`: setting the cutpoint to 15. Don't worry about the labels; Arbor will take care of them.](art/age-config.png)
:::
...
[Learn more about the configuration box](08.90-arbor-configuration.qmd).
